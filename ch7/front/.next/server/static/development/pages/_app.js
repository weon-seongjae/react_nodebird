...
var ImagesZoom = function ImagesZoom(_ref) {
  ...
  }, "\uC0C1\uC138\uC774\uBBF8\uC9C0"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_3__["Icon"], {
    type: "close",
    onClick: onClose,
    style: {
      position: 'absolute',
...
var PostImages = function PostImages(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("img", {
    ...
    type: "plus"
  }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null), images.length - 1, "\uAC1C\uC758 \uC0AC\uC9C4 \uB354\uBCF4\uAE30")), showImagesZoom && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_Imagezoom__WEBPACK_IMPORTED_MODULE_4__["default"], {
    images: images,
    onClose: onClose
  }));
};
...
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./index */ "./pages/index.js");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (ctx.isServer) {
              axios__WEBPACK_IMPORTED_MODULE_10___default.a.defaults.headers.Cookie = cookie; // 직접 쿠키를 넣어줌.
            }
...
var configureStore = function configureStore(initialState, options) {
  ...
  store.sagaTask = sagaMiddleware.run(_sagas__WEBPACK_IMPORTED_MODULE_13__["default"]); // 서버사이드 렌더링할 때 store.sagaTask를 변수로 설정. withReduxSaga가 내부에서 필요로 함

  return store;
};

/* harmony default export */ __webpack_exports__["default"] = (next_redux_wrapper__WEBPACK_IMPORTED_MODULE_5___default()(configureStore)(next_redux_saga__WEBPACK_IMPORTED_MODULE_6___default()(NodeBird))); // 레이아웃은 _app.js에서 코딩을 한다.
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  switch (action.type) {
    ...
    case UPLOAD_IMAGES_SUCCESS:
      {
        return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, state, {
          imagePaths: [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(state.imagePaths), Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(action.data)) // 이미지 미리보기 할 수 있는 경로들
...
function loadHashtagPostsAPI(tag) {
  return axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/hashtag/".concat(tag)); // 서버에 요청
  // withCredentials : true는 붙이지 않아도 됨. 로그인하지 않는 사람도 게시글은 볼 수 있음.
}
...
function loadUserPostsAPI(id) {
  return axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/user/".concat(id, "/posts")); // 서버에 요청
  // withCredentials : true는 붙이지 않아도 됨. 로그인하지 않는 사람도 게시글은 볼 수 있음.
}
