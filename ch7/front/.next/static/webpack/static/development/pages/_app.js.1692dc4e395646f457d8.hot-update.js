...
function loadFollowersAPI(userId) {
  ...
  // 서버에 요청을 보내는 부분
  return axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/user/".concat(userId || 0, "/followers?offset=").concat(offset), {
    // get은 데이터가 없기 때문에 두번째가 바로 설정이 된다.
    withCredentials: true // 서버의 app.use(cors)에서 쿠키를 받는다.
...
//# sourceMappingURL=_app.js.1692dc4e395646f457d8.hot-update.js.map