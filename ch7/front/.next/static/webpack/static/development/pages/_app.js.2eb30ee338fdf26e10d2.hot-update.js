...
function removePostAPI(postId) {
  // 서버에 요청을 보내는 부분
  return axios__WEBPACK_IMPORTED_MODULE_2___default.a.post("/post/".concat(postId, "/removePost"), {}, {
    // post로 요청할 때는 data가 없더라도 빈 객체라도 넣어주어야 함.
    withCredentials: true // 로그인한 사용자만 이미지 올릴 수 있음.
  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function removePost$(_context21) {
    while (1) {
      switch (_context21.prev = _context21.next) {
        ...
        case 13:
          alert(_context21.t0.response && _context21.t0.response.data);
  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function watchRemovePost$(_context22) {
    while (1) {
      switch (_context22.prev = _context22.next) {
        case 0:
          _context22.next = 2;
          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_1__["takeLatest"])(_reducers_post__WEBPACK_IMPORTED_MODULE_3__["RETWEET_REQUEST"], removePost);
...
//# sourceMappingURL=_app.js.2eb30ee338fdf26e10d2.hot-update.js.map